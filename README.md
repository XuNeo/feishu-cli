...
- **AI Agent 原生** — 1 个技能文件（含 references 分层结构）覆盖飞书全功能，AI 助手即装即用
...
`skills/` 目录包含 **1 个** 为 [Claude Code](https://claude.ai/claude-code) 设计的技能文件，让 AI Agent 能够直接操作飞书 — 创建文档、发送消息、管理权限，全部通过自然语言驱动。
